...
const UserSnippetsArgs_1 = require("./args/UserSnippetsArgs");
const helpers_1 = require("../../../helpers");
let UserRelationsResolver = class UserRelationsResolver {
    async snippets(user, ctx, args) {
...
__decorate([
    TypeGraphQL.FieldResolver(_type => [Snippet_1.Snippet], {
        nullable: false
    }),
    ...
    __metadata("design:paramtypes", [User_1.User, Object, UserSnippetsArgs_1.UserSnippetsArgs]),
    __metadata("design:returntype", Promise)
], UserRelationsResolver.prototype, "snippets", null);
