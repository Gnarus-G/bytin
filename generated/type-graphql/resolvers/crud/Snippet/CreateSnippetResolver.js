...
exports.CreateSnippetResolver = void 0;
...
let CreateSnippetResolver = class CreateSnippetResolver {
...
], CreateSnippetResolver.prototype, "createSnippet", null);
CreateSnippetResolver = __decorate([
    TypeGraphQL.Resolver(_of => Snippet_1.Snippet)
], CreateSnippetResolver);
exports.CreateSnippetResolver = CreateSnippetResolver;
